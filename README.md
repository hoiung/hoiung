...
Co-founded an international Brazilian Zouk dance school with my partner, and built one of the largest Brazilian Zouk communities online while running its live events. Served as Programme Director; led, trained, and coached a 15-person distributed planning team across multiple countries; worked with international dance instructors as event partners. 20+ international events, 35% revenue growth, 25% enrolment growth, over ~7 years alongside the day job. I'm now doing the same for [Asians & Gingers in Tech](https://hoiboy.uk/community/asians-gingers-in-tech/). Building and leading communities is the thread through everything I do.
